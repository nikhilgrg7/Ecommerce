...
public class ServiceLayer {
	...
	//....................... updating password for seller..........................................
	public Seller sellerPassword(Long sellerId, PasswordRequest request) {
	...
	public ResponseEntity<APIResponse> deleteFromSeller(Long sellerId) {
		return sellerRepo.findById(sellerId).map(obj -> {
			sellerRepo.delete(obj);
	...
	// ........................updating password for buyer........................................
	public Buyer buyerPassword(Long buyerId, PasswordRequest request) {

		// TODO Auto-generated method stub
		Buyer b1 = buyerRepo.findById(buyerId).get();
		b1.setPassword(request.getPassword());
		buyerRepo.save(b1);
		return b1;
	}
	...
	public ResponseEntity<APIResponse> deleteFromBuyer(Long buyerId) {
		return buyerRepo.findById(buyerId).map(obj -> {
			buyerRepo.delete(obj);
...
//...............................  place order...................................................... 
	...
	public Product updateProduct(Long productId, ProductRequest request) {
		...
		// TODO Auto-generated method stub
		Product p1 = productRepo.findById(productId).get();
		p1.setProductName(request.getProductName());
		p1.setProduct(request.getProduct());
		p1.setPrice(request.getPrice());
		p1.setQuantity(request.getQuantity());
		productRepo.save(p1);
		return p1;
	}
}