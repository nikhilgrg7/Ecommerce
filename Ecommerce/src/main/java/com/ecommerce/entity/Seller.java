...
public class Seller {
	...
	public String toString() {
		return "Account [sellerId=" + sellerId + ", name=" + name + ", address=" + address + ", mobile=" + mobile
				+ ", username=" + username + ", password=" + password + ", approval=" + approval + ", getSellerId()="
				+ getSellerId() + ", getName()=" + getName() + ", getAddress()=" + getAddress() + ", getMobile()="
				+ getMobile() + ", getUserName()=" + getUsername() + ", getPassword()=" + getPassword()
